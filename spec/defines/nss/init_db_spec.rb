require 'spec_helper'
describe 'ipsec::nss::init_db', :type => :define do
  context 'supported operating systems' do
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        let(:common_params) { { :dbdir => '/etc/ipsec.d', :password => 'mypassword', :init_command => '/sbin/ipsec init_nssdb', :token => 'NSS Certificate DB' } }
