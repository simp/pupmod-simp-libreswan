    ...
    on_supported_os.each do |os, facts|
      context "on #{os}" do
        ...
        context "ipsec class with firewall enabled" do
          ...
          it { is_expected.to contain_class('ipsec::config::firewall').that_notifies('ipsec::service') }
        ...
        context "ipsec class with logging enabled" do
          ...
          it { is_expected.to contain_class('ipsec::config::logging').that_notifies('ipsec::service') }
        end
