    ...
    on_supported_os.each do |os, os_facts|
      context "on #{os}" do
        ...
        context 'libreswan class with firewall enabled' do
          ...
          it {
            is_expected.to create_simp_firewalld__rule('ipsec_allow')
          ...
          it {
            is_expected.to create_simp_firewalld__rule('allow_protocol_esp')
              .with_trusted_nets(params[:trusted_nets])
              .with_apply_to('all')
              .with_protocol('esp')
              .with_order(15)
          ...
          it {
            is_expected.to create_simp_firewalld__rule('allow_protocol_ah')
              .with_trusted_nets(params[:trusted_nets])
              .with_apply_to('all')
              .with_protocol('ah')
              .with_order(15)
