...
describe 'ipsec class' do
  ...
  context 'default parameters' do
    ...
    it 'should be listening on port 500' do
       on server, "netstat -nuap | grep '^udp.* [dd]d.[dd]d.[dd]d.[dd]d:500 .*/pluto'", :acceptable_exit_codes => [0]
    end
    it 'should be listening on port 4500' do
       on server, "netstat -nuap | grep '^udp.* [dd]d.[dd]d.[dd]d.[dd]d:4500 .*/pluto'", :acceptable_exit_codes => [0]
    end
