...
#
# @param enable_auditing [Boolean] If true, manage auditing for ipsec.
#
# @param simp_firewall [Boolean] If true, manage firewall rules to acommodate ipsec.
#
# @param enable_logging [Boolean] If true, manage logging configuration for ipsec.
#
